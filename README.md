...
- __intArray2d__ - занимается выделением памяти под массив и определением базовых операций над ним, [_подробнее здесь_](https://github.com/serega-drakon/dynamic-massive).
